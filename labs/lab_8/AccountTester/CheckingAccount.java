public class CheckingAccount extends BankAccount
{
    ...
    {
        return "CheckingAccount[balance=" + this.getBalance() + ", transactionCount=" + this.getTransactionCount() + "]";
    }

    public boolean equals(CheckingAccount obj)
    {
        return (super.equals(obj) && (this.getTransactionCount() == obj.getTransactionCount()));
    }
