    ...
    private static void testAccount(BankAccount a)
    {
        ...
        */
        ...
        {   TimeDepositAccount ta = (TimeDepositAccount) a;
            for (int i = 0; i < 10; i++) // per 10 mesi aggiungi interessi
            {
                ta.addInterest();
                ta.withdraw(5);
                System.out.println("Interessi fine mese:\n     " + a);
            }
            newa = new TimeDepositAccount(ta.getBalance(), ta.getInterestRate(), ta.getMonthsCount()); 
        }
